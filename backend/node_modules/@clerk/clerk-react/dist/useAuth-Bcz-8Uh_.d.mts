...
import { W as WithClerkProp } from './types-BAMVj4gL.mjs';
...
declare const RedirectToTasks: {
    (props: _clerk_types.Without<WithClerkProp<_clerk_types.TasksRedirectOptions>, "clerk">): React.JSX.Element | null;
    displayName: string;
};
/**
 * @function
