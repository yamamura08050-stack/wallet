 ...
 */
export declare const getClerkInstance: (options?: import("./types").BuildClerkOptions) => import("@clerk/clerk-react").HeadlessBrowserClerk | import("@clerk/clerk-react").BrowserClerk;
