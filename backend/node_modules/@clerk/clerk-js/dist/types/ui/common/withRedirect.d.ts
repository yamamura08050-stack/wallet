...
export declare const withRedirectToSignInTask: <P extends AvailableComponentProps>(Component: ComponentType<P>) => {
    (props: P): JSX.Element | null;
    displayName: string;
};
export declare const withRedirectToSignUpTask: <P extends AvailableComponentProps>(Component: ComponentType<P>) => {
    (props: P): JSX.Element | null;
    displayName: string;
};
export {};
